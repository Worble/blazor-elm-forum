...
var _user$project$Models$emptyBoard = {
	name: '',
	shorthandName: '',
	id: 0,
	threads: {ctor: '[]'},
	thread: _user$project$Models$emptyThread
};
var _user$project$Models$model = function (route) {
	return {
		text: '',
		boards: {ctor: '[]'},
...
var _user$project$Models$Thread = F4(
	function (a, b, c, d) {
...
var _user$project$Models$PostsRoute = F2(
	function (a, b) {
		return {ctor: 'PostsRoute', _0: a, _1: b};
	});
var _user$project$Models$ThreadsRoute = function (a) {
	return {ctor: 'ThreadsRoute', _0: a};
};
...
var _user$project$Decoders$decodeThread = A3(
	...
	A3(
		...
		A4(
			...
			'post',
			_user$project$Decoders$decodePost,
			_user$project$Models$emptyPost,
			A4(
				_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$optional,
				'posts',
...
var _user$project$Decoders$decodeBoard = A4(
	...
	_user$project$Models$emptyThread,
	A4(
		_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$optional,
		'threads',
...
var _user$project$Msgs$Echo = function (a) {
	return {ctor: 'Echo', _0: a};
};
var _user$project$Msgs$RedirectPostsForThread = function (a) {
...
var _user$project$Msgs$GetPostsForThread = function (a) {
	return {ctor: 'GetPostsForThread', _0: a};
};
var _user$project$Msgs$GetThreadsForBoard = function (a) {
	return {ctor: 'GetThreadsForBoard', _0: a};
};
var _user$project$Msgs$GetBoards = function (a) {
...
var _user$project$Routing$threadsPath = function (boardId) {
	return A2(
		_elm_lang$core$Basics_ops['++'],
		'/#boards/',
		A2(
...
var _user$project$Routing$boardsPath = '/#boards';
var _user$project$Routing$errorPath = '/#404';
var _user$project$Routing$matchers = _evancz$url_parser$UrlParser$oneOf(
	{
		ctor: '::',
		_0: A2(_evancz$url_parser$UrlParser$map, _user$project$Models$BoardsRoute, _evancz$url_parser$UrlParser$top),
		_1: {
			ctor: '::',
			_0: A2(
				_evancz$url_parser$UrlParser$map,
				_user$project$Models$ThreadsRoute,
				A2(
				...
				_0: A2(
					...
					A2(
						...
						A2(
							_evancz$url_parser$UrlParser_ops['</>'],
							_evancz$url_parser$UrlParser$int,
							_evancz$url_parser$UrlParser$s('threads')))),
				_1: {
					ctor: '::',
					_0: A2(
						_evancz$url_parser$UrlParser$map,
						_user$project$Models$BoardsRoute,
						_evancz$url_parser$UrlParser$s('boards')),
					_1: {
						ctor: '::',
						_0: A2(
							_evancz$url_parser$UrlParser$map,
							_user$project$Models$PostsRoute,
							A2(
								_evancz$url_parser$UrlParser_ops['</>'],
								_evancz$url_parser$UrlParser$s('boards'),
								A2(
...
var _user$project$Subscriptions$subscriptions = function (model) {
	return (_elm_lang$core$Native_Utils.cmp(model.board.thread.id, 0) > 0) ? A2(
		_elm_lang$websocket$WebSocket$listen,
		A2(
			_elm_lang$core$Basics_ops['++'],
			'ws://localhost:14190/api/boards/',
			A2(
				_elm_lang$core$Basics_ops['++'],
				_elm_lang$core$Basics$toString(model.board.id),
				A2(
					_elm_lang$core$Basics_ops['++'],
					'/threads/',
					A2(
						_elm_lang$core$Basics_ops['++'],
						_elm_lang$core$Basics$toString(model.board.thread.id),
						'/posts/ws')))),
		_user$project$Msgs$Echo) : _elm_lang$core$Platform_Sub$none;
};
			...
			case 'GetBoards':
				if (_p0._0.ctor === 'Ok') {
					...
					return {
						...
						_1: _elm_lang$navigation$Navigation$newUrl(_user$project$Routing$errorPath)
					};
				}
				...
				if (_p0._0.ctor === 'Ok') {
					...
					return {
						...
						_1: _elm_lang$navigation$Navigation$newUrl(
							A2(_user$project$Routing$postsPath, _p1.id, _p1.thread.id))
					};
				} else {
					return {
						ctor: '_Tuple2',
...
var _user$project$Views_Boards$displayBoards = function (board) {
	return A2(
			...
			_0: A2(
				_elm_lang$html$Html$a,
				{
					...
					_0: _elm_lang$html$Html_Attributes$href(
						_user$project$Routing$threadsPath(board.id)),
					_1: {ctor: '[]'}
				},
				{
					ctor: '::',
		...
		{ctor: '[]'},
		{
			...
			_1: {
				...
				_0: A2(
					...
					{ctor: '[]'},
					A2(_elm_lang$core$List$map, _user$project$Views_Boards$displayBoards, model.boards)),
				_1: {ctor: '[]'}
			}
		});
};
...
var _user$project$Views_Shared_Navbar$view = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{ctor: '[]'},
		{
			...
			_1: {
				...
				_0: A2(
					_elm_lang$html$Html$span,
					{ctor: '[]'},
					A2(_elm_lang$core$List$map, _user$project$Views_Shared_Navbar$displayBoards, model.boards)),
				_1: {ctor: '[]'}
			}
		});
};
...
var _user$project$Views_Posts$view = function (model) {
	return A2(
		...
		{
			ctor: '::',
			_0: _user$project$Views_Shared_Navbar$view(model),
			_1: {
				ctor: '::',
				_0: A2(
					_elm_lang$html$Html$h1,
			...
			_1: {
				...
				_0: A2(
					...
					{ctor: '[]'},
					{
						ctor: '::',
						_0: _elm_lang$html$Html$text(
							A2(_elm_lang$core$Basics_ops['++'], 'Threads in board ', model.board.name)),
						_1: {ctor: '[]'}
					}),
				_1: {
					ctor: '::',
	...
	return A2(
		...
		{ctor: '[]'},
		{
			...
			_0: function () {
				...
				switch (_p0.ctor) {
					case 'BoardsRoute':
						return _user$project$Views_Boards$view(model);
					case 'ThreadsRoute':
						return _user$project$Views_Threads$view(model);
					case 'PostsRoute':
						return _user$project$Views_Posts$view(model);
					default:
						return A2(
							_elm_lang$html$Html$div,
							{ctor: '[]'},
...
var _user$project$Main$init = function (location) {
	...
	return {
		...
		_1: _elm_lang$core$Platform_Cmd$batch(
			{
				ctor: '::',
				_0: _user$project$Commands$performLocationChange(currentRoute),
				_1: {
					ctor: '::',
					_0: _user$project$Commands$getBoards,
					_1: {ctor: '[]'}
				}
			})
	};
