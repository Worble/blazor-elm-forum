...
var _user$project$Views_Boards$view = function (boards) {
	return A2(
		...
		{ctor: '[]'},
		{
			...
			_1: {
				...
				_0: A2(
					...
					{ctor: '[]'},
					A2(_elm_lang$core$List$map, _user$project$Views_Boards$displayBoards, boards)),
				_1: {ctor: '[]'}
			}
		});
};
...
var _user$project$Views_Threads$displayThreads = function (model) {
	return A2(
		_elm_lang$core$List$map,
		function (n) {
			var _p0 = _elm_lang$core$List$head(n.posts);
			if (_p0.ctor === 'Just') {
				return A2(
					_elm_lang$html$Html$li,
					{ctor: '[]'},
					{
						...
						_0: A2(
							_elm_lang$html$Html$a,
							{
								ctor: '::',
								_0: _elm_lang$html$Html_Attributes$href(
									A2(_user$project$Routing$postsPath, model.board.id, n.id)),
								_1: {ctor: '[]'}
							},
							{
								ctor: '::',
								_0: _elm_lang$html$Html$text(_p0._0.content),
								_1: {ctor: '[]'}
							}),
						_1: {ctor: '[]'}
					});
		...
		{ctor: '[]'},
		{
			...
			_1: {
				...
				_0: function () {
					...
					switch (_p0.ctor) {
						case 'BoardsRoute':
							return _user$project$Views_Boards$view(model.boards);
						case 'ThreadsRoute':
